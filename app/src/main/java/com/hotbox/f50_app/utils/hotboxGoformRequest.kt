...
class HotboxGoformRequest(private val baseUrl: String) {
    ...
    suspend fun login(password: String): String? = withContext(Dispatchers.IO) {
        ...
        HotboxLog.d("UFI_TOOLS_LOG", "Login hash: ${pwdHash}")
        ...
        client.newCall(req).execute().use { res ->
            ...
            HotboxLog.d("UFI_TOOLS_LOG", "Login result: ${bdy}")
            ...
            HotboxLog.d("UFI_TOOLS_LOG", "Login cookie: ${header}")
    ...
    suspend fun getData(
        ...
        try {
            ...
            HotboxLog.e("UFI_TOOLS_LOG", "getData Exception: ${e.message}")
